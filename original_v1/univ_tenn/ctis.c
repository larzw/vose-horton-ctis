...
#ifndef FTHREADS
  #define FTHREADS 4                                             // number of threads for fftw
#endif
...
#ifndef COMPUTE_PT
  #define COMPUTE_PT  0                                          // compute P^T and store to disk
#endif

#ifndef REMOVE_NOISE
  #define REMOVE_NOISE 1                                         // remove noise 
#endif
...
#ifndef SEED
  #define SEED         37                                        // random number generator seed
#endif
...
#ifndef LIM
  #define LIM           2                                        // cg iteration threshold
#endif
...
printf("dkdk\n");  
  ...
  f = malloc(sizeof(double)*m);                 // image
